...
// NEW: Heart Icon for favoriting with hover effects
...
const URI = '/api/v1/predictions/guest/predict';
...
                {/* NEW: Heart Icon Overlay for uploaded image */}
                <HeartIcon 
...
                {/* NEW: Heart Icon Overlay for prediction result image */}
                <HeartIcon
                  isFavorited={isFavorited} 
                  onClick={handleToggleFavorite} 
                  className={`absolute top-3 right-3 w-10 h-10 ${isFavorited ? 'text-red-500' : 'text-white'}`} 
