...
const ModeToggle = () => {
    ...
    return (
        <button onClick={SWITCH_THEME}
            className="absolute top-1 right-12 md:-right-2 md:top-1.4 mr-1 flex size-6 z-10 cursor-pointer items-center justify-center rounded-xl px-1 py-1 border bg-white/80 border-white/80 dark:border-neutral-800 dark:bg-background"
        >
